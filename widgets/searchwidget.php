...
return [
    ...
    'render' => function ($widget) use ($app) {
        ...
        return $app['view']('friendlyit/search:views/widget/widget-search.php', compact('widget', 'options', 'result_per_page', 'triggering_chars', 'char_limit', 'css_enabled', 'upper_limit'));
    }
];